  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e7]:
      - generic [ref=e9]:
        ...
        - code [ref=e17]:
          - generic [ref=e18]:
            - textbox "Editor content" [active] [ref=e19]: "function calculateTotal(items) { let total = 0; for (let i = 0; i < items.length; i++) { total += items[i].price * items[i].quantity; } return total; } const cart = [ {} ] } }"
            - generic [ref=e21]:
              - generic [ref=e22]:
